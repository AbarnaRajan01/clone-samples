...
function Slider() {
  ...
  return (
    <div>
        <HiChevronLeft className='hidden md:block text-white absolute 
        text-[30px] mx-8 mt-[150px] cursor-pointer'
         onClick={()=>sliderLeft(elementRef.current)}/>
        <HiChevronRight className='hidden md:block text-white absolute
         text-[30px] mx-8 mt-[150px] cursor-pointer right-0'
